...
@interface CPColorPickerTableCell : PSControlTableCell
@property(nonatomic, retain) UIColorWell *colorPreview API_AVAILABLE(ios(14.0));
@property(nonatomic, retain) CPColorWell *colorPreviewLegacy;
@end
